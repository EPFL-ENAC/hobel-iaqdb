      ...
      <div class="row q-gutter-md">
        <div class="col" style="max-width: 200px;">
          <div class="q-mb-md q-mt-sm">
            <div v-for="(dataset, i) in contrib.study.datasets"
            :key="dataset.id">
              <q-btn
                flat
                no-caps
          ...
          <q-btn @click="onShowDataFile" color="secondary" label="Add dataset" icon="add" size="sm" class="full-width"/>
        </div>
