export default {
  ...
  plots: {
    ...
    datasets_by_building_type: 'Datasets by building type',
    datasets_by_building_type_hint: 'Number of datasets per building type containing the selected pollutant.',
    datasets_by_ventilation: 'Datasets by ventilation system',
    datasets_by_ventilation_hint: 'Number of datasets per building ventilation containing the selected pollutant.',
    datasets_by_climate_zone: 'Datasets by climate zone',
    datasets_by_climate_zone_hint: 'Number of datasets per Köppen climate zone containing the selected pollutant. Click a zone to see its countries.',
    parameters: 'Air pollutant',
    parameters_hint: 'Datasets that contain the selected parameters (none selected: all datasets)',
    records_by_pollutant: 'Records by pollutant',
    records_by_pollutant_hint: 'Number of records and completeness per pollutant. The selected pollutants are highlighted.',
    records_by_month: 'Records by month',
    records_by_month_hint: 'Number of records per calendar month, stacked by pollutant. Narrow the years with the measurement year filter.',
    all_years: 'All years',
    since_year: 'Since {year}',
    until_year: 'Until {year}',
    peak_month: 'peak {month} {lift}',
    measurement_period: 'Measurement period',
    measurement_period_hint: 'Cumulative number of datasets containing the selected pollutant, by year of their first measurement.',
    datasets: 'Datasets',
    year_span: '{count}-year span',
    added_in_year: '+{count} added',
    descriptive_stats: 'Descriptive statistics',
    descriptive_stats_hint: 'Distribution of daily means of a pollutant per context: observed range, 5th/25th/50th/75th/95th percentiles and mean. Click a row to drill down.',
    pollutant: 'Pollutant',
    context: 'Context',
    observed_range: 'Observed range',
    percentile_landmarks: 'Percentile landmarks',
    mean: 'Mean',
    sd: 'Std.',
    min: 'Min.',
    max: 'Max.',
    ...
    p95: '95th percentile',
    days: 'Daily values',
    daily_means: 'daily means',
    benchmark_comparison: 'Benchmark comparison',
    benchmark_comparison_hint: 'Median of the filtered datasets and of the whole database per context, against the reference value of the pollutant. The right column is the share of periods at or below it. Click a row to drill down.',
    benchmark: 'Benchmark',
    placeholder: 'Placeholder',
    no_benchmark: 'No benchmark yet for {parameter}.',
    datasets_filtered: 'Datasets filtered',
    database_median: 'Database median',
    below_benchmark: '{share} of periods at or below the benchmark',
    below_benchmark_short: '≤ limit',
    trends: 'Trends',
    trends_hint: 'Median of daily means per month for a year, with the interquartile range and the reference value. Narrow it to a context; click a month to see its days.',
    year: 'Year',
    no_context: 'All',
    context_value: 'Value',
    ...
    peak: 'Peak {value} ({period})',
    low: 'Low {value} ({period})',
    exceedance_over_time: 'Exceedance over time',
    exceedance_over_time_hint: 'Share of days (hours for 8-hour guidelines) above the reference value, per calendar month. Click a month to see it year by year.',
    month_of_year: 'Month',
    share_above: 'Share above',
    share_above_hint: 'Above {benchmark}, counted in {periods}.',
    averaging_day: 'days',
    averaging_hour: 'hours',
    above_of_total: '{above} of {total} {unit} above',
    relationship: 'Relationships: pollutant × occupancy',
    relationship_hint: 'Mean of the pollutant per space against occupancy, with a least-squares trend line. Other space and building metrics can be picked; only those with data are listed.',
    metric: 'Metric',
    metrics: {
      space_occupancy_density: 'Occupancy density',
      space_occupancy_number: 'Number of occupants',
      space_floor_area: 'Floor area (m²)',
      space_space_volume: 'Space volume (m³)',
      building_airtightness: 'Airtightness',
    ...
    sampled: 'sampled',
    relationship_ventilation: 'Relationships: pollutant × ventilation',
    ...
    correlation_matrix: 'Relationships: multi-pollutant correlation matrix',
    correlation_matrix_hint: 'Correlation between pollutants measured in the same space at the same hour. Pearson measures a linear relationship; Spearman ranks the values first, so it is robust to outliers and skewed data. Click a cell to see the pair.',
    pollutants_max: 'Pollutants (up to {max})',
    pick_two_pollutants: 'Pick at least two pollutants.',
    no_pairs_matrix: 'These pollutants were never measured in the same space at the same hour for these filters.',
    method: 'Method',
    pearson: 'Pearson',
    spearman: 'Spearman',
    paired_hours: 'Hourly means, paired per space',
    no_common_hours: 'Never measured together',
    paired_hours_count: '{count} paired hours',
    custom_relationship: 'Relationships: custom pair',
    custom_relationship_hint: 'Hourly means of two variables measured in the same space, with a least-squares trend line. Only pollutants measured together are offered; a correlation matrix cell opens its pair here.',
    x_variable: 'X variable',
    y_variable: 'Y variable',
    no_pairs_for: 'Nothing was measured together with {parameter} for these filters.',
    observations: 'Observations',
    trend_label: '{strength} {direction} trend',
    trend_none: 'No clear trend',
    trend_weak: 'Weak',
    ...
    metadata_availability_hint: 'Share of records with each metadata field filled in. "Other …" fields, filled only when the main field says "other", are left out.',
    entity: 'Entity',
    entities: {
      studies: 'Studies',
      buildings: 'Buildings',
    ...
    fields_count: 'No fields | 1 field | {count} fields',
    above_share: '{count} above {share}',
    available: 'Available',
    present_of_total: '{present} of {total} filled in',
    quality: {
      strong: 'Strong (≥ 80%)',
      review: 'Review (70–80%)',
      gap: 'Gap (< 70%)',
    },
    never_filled: 'Never filled in: {fields}.',
    ...
    levels: {
      parameter: 'No pollutants | 1 pollutant | {count} pollutants',
      country: 'No countries | 1 country | {count} countries',
      city: 'No cities | 1 city | {count} cities',
      climate_zone: 'No climate zones | 1 climate zone | {count} climate zones',
      building_type: 'No building types | 1 building type | {count} building types',
      ventilation: 'No ventilation statuses | 1 ventilation status | {count} ventilation statuses',
      ventilation_type: 'No ventilation types | 1 ventilation type | {count} ventilation types',
      study: 'No studies | 1 study | {count} studies',
      dataset: 'No datasets | 1 dataset | {count} datasets',
      space_type: 'No space types | 1 space type | {count} space types',
    },
