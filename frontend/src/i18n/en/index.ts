export default {
  ...
  plots: {
    ...
    correlation_matrix_hint: 'Correlation between pollutants measured in the same space at the same hour. Pearson measures a linear relationship; Spearman ranks the values first, so it is robust to outliers and skewed data.',
