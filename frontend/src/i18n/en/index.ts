...
export default {
  ...
  study: {
    ...
    building_count_hint: 'Number of buildings in the study (can be higher than the ones described).',
    space_count: 'Space count',
    space_count_hint: 'Number of spaces in the study (can be higher than the ones described).',
    url: 'Website address',
    ...
    building: {
      ...
      certification_program_hint: 'Name of the green building certification program.',
