...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_studyperson_study_id"),
                    "studyperson", ["study_id"], unique=False)
    op.create_index(op.f("ix_studyperson_person_id"),
                    "studyperson", ["person_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_studyperson_person_id"),
                  table_name="studyperson")
    op.drop_index(op.f("ix_studyperson_study_id"),
                  table_name="studyperson")
    op.drop_table("studyperson")
